...
zramswap.nix enables swap on zram (set to 1/2 RAM for systems with <32GiB, or 16GiB for systems with >32GiB) and sets swappiness to optimal settings for it. This should not be used in conjunction with a swap file/partition/zswap. It also enables earlyoom.
